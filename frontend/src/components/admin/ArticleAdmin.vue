      ...
      <b-row>
        <b-col xs="12">
          ...
          <b-form-group label="Descrição" label-for="article-description">
            <b-form-input id="article-description" type="text" v-model="article.description" required :readonly="mode === 'remove'" placeholder="Descreva o artigo"/>
          </b-form-group>
          <b-form-group label="Imagem (URL)" label-for="article-imageUrl" v-if="mode === 'save'">
            <b-form-input id="article-imageUrl" type="text" v-model="article.imageUrl" required :readonly="mode === 'remove'" placeholder="Informe o URL da imagem"/>
          </b-form-group>
